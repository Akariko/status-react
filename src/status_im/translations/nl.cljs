...
(def translations
  {
   ...
   :camera-access-error                   "Om de benodigde camera toestemming te verlenen, ga naar jouw systeemconfiguratie en bevestig dat Status > Camera is geselecteerd."
   :photos-access-error                   "Om de benodigde foto's toestemming te verlenen, ga naar jouw systeemconfiguratie en bevestig dat Status > Foto's is geselecteerd."
   ...
   :error-incorrect-email                 "Onjuist emailadres"
